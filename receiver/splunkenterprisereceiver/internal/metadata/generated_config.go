...
// ResourceAttributesConfig provides config for splunkenterprise resource attributes.
type ResourceAttributesConfig struct {
	SplunkBuildInfo   ResourceAttributeConfig `mapstructure:"splunk.build.info"`
	SplunkVersionInfo ResourceAttributeConfig `mapstructure:"splunk.version.info"`
}

func DefaultResourceAttributesConfig() ResourceAttributesConfig {
	return ResourceAttributesConfig{
		SplunkBuildInfo: ResourceAttributeConfig{
			Enabled: false,
		},
		SplunkVersionInfo: ResourceAttributeConfig{
			Enabled: false,
		},
	}
}
